...
<body>
    ...
    <div class="container">
        <h1>Về Chúng Tôi</h1>
        <p>Chào mừng đến với trang web học toán lớp 5! Chúng tôi là một nhóm các nhà giáo dục và chuyên gia toán học đam mê, với mục tiêu mang đến cho học sinh những công cụ và tài liệu hỗ trợ tốt nhất để nâng cao kiến thức và kỹ năng toán học.</p>
        ...
        <ul>
            <li><strong>Tiếp cận nội dung miễn phí:</strong> Cung cấp nhiều tài liệu và bài giảng miễn phí, giúp học sinh có thể học mọi lúc, mọi nơi.</li>
            <li><strong>Bài tập đa dạng:</strong> Cung cấp hệ thống bài tập phong phú từ dễ đến khó, phù hợp với mọi trình độ của học sinh lớp 5.</li>
            <li><strong>Tự đánh giá và theo dõi tiến độ:</strong> Giúp học sinh tự kiểm tra kiến thức của mình qua các bài kiểm tra và theo dõi quá trình học tập.</li>
        </ul>
    </div>
    <!-- Main End -->
