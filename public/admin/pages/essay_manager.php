                                          ...
                                          <td>
                                              <div class="dropdown">
                                                  ...
                                                  <div class="dropdown-menu">
                                                      <a class="dropdown-item" href="add_update_essay.php?id=<?php echo $cauHoi['MaCauHoi']; ?>"><i class="ri-pencil-line me-1"></i> Chỉnh sửa</a>
                                                      <a class="dropdown-item" href="#" onclick="confirmDelete('<?php echo $cauHoi['MaCauHoi']; ?>')"><i class="ri-delete-bin-6-line me-1"></i> Xóa</a>
                                                  </div>
                                              </div>
                                          </td>
                                      </tr>
      ...
      <script>
          function confirmDelete(maCauHoi) {
              if (confirm('Bạn có chắc chắn muốn xóa câu hỏi này?')) {
                  window.location.href = 'delete_cauhoituluan.php?id=' + maCauHoi;
              }
          }
      </script>
   </body>
