                                        ...
                                        <tbody>
                                            <?php foreach ($baiGiaiList as $baiGiai): ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo mb_substr(htmlspecialchars($baiGiai['Bai']), 0, 30) . (mb_strlen($baiGiai['Bai']) > 30 ? '...' : ''); ?></td>
                                                    <td><?php echo mb_substr(htmlspecialchars($baiGiai['LoiGiai']), 0, 30) . (mb_strlen($baiGiai['LoiGiai']) > 30 ? '...' : ''); ?></td>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item" href="add_update_solutions.php?id=<?php echo $baiGiai['MaBaiGiai']; ?>"><i class="ri-pencil-line me-1"></i> Chỉnh sửa</a>
